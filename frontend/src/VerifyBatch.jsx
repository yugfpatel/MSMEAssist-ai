  ...
  return (
    <div className="verify-container" style={{ padding: "40px 20px", maxWidth: "650px", margin: "0 auto", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif", background: "#f8fafc", minHeight: "100vh", color: "#0f172a" }}>
      <div style={{ textAlign: "center", marginBottom: "40px", paddingBottom: "30px", borderBottom: "2px solid #e2e8f0" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", padding: "12px", background: "#ffffff", borderRadius: "4px", border: "1px solid #e2e8f0", width: "fit-content", margin: "0 auto", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }}>
          <QRCode value={window.location.href} size={90} fgColor="#0f172a" />
        </div>
      </div>

      <div style={{ background: "#ffffff", padding: "32px", borderRadius: "8px", border: "1px solid #e2e8f0", marginBottom: "24px", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
        <h2 style={{ margin: "0 0 16px 0", color: "#059669", fontSize: "18px", fontWeight: "700" }}>Batch Details</h2>
      ...
      <div style={{ background: "#ffffff", padding: "32px", borderRadius: "8px", border: "1px solid #e2e8f0", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
        <h2 style={{ margin: "0 0 24px 0", color: "#059669", fontSize: "18px", fontWeight: "700" }}>Journey Timeline</h2>
        <div className="timeline" style={{ borderLeft: "2px solid #34d399", paddingLeft: "24px", marginLeft: "12px" }}>
          {(blockchain?.records || []).map((rec, i) => (
            <div key={i} style={{ marginBottom: "24px", position: "relative" }}>
              <div style={{ position: "absolute", left: "-31px", top: "4px", width: "12px", height: "12px", background: "#059669", borderRadius: "50%", boxShadow: "0 0 0 4px #d1fae5" }}></div>
